...
class LarsConcaveHull{
     ...
     * @param threshold
     */
    public LarsConcaveHull(Geometry geometry, double threshold) {
     ...
     */
    public Geometry getConcaveHull() throws IndexOutOfBoundsException {
     ...
     * 		the concave hull
     */
    private Geometry prepareConcaveHull() throws IndexOutOfBoundsException {
        ...
        try {
            ...
            throw new IndexOutOfBoundsException(this.geometries.toString());
        }

        return createConcaveHull();
    }

    /**
     * The concave hull algorithm. Based on Duckham and al. (2008) defined in the paper
     * untitled "Efficient generation of simple polygons for characterizing
     * the shape of a set of points in the plane".
     *
